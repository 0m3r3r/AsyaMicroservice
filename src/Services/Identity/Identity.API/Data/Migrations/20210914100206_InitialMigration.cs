    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "varchar(450)", nullable: false),
                    CardNumber = table.Column<string>(type: "varchar(1000)", nullable: false),
                    SecurityNumber = table.Column<string>(type: "varchar(1000)", nullable: false),
                    Expiration = table.Column<string>(type: "varchar(1000)", nullable: false),
                    CardHolderName = table.Column<string>(type: "varchar(1000)", nullable: false),
                    CardType = table.Column<int>(type: "int", nullable: false),
                    Street = table.Column<string>(type: "varchar(1000)", nullable: false),
                    City = table.Column<string>(type: "varchar(1000)", nullable: false),
                    State = table.Column<string>(type: "varchar(1000)", nullable: false),
                    Country = table.Column<string>(type: "varchar(1000)", nullable: false),
                    ZipCode = table.Column<string>(type: "varchar(1000)", nullable: false),
