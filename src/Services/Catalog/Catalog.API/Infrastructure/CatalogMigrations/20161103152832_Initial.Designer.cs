    ...
    partial class Initial
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            modelBuilder
                ...
                .HasAnnotation("Npgsql:Sequence:.catalog_brand_hilo", "'catalog_brand_hilo', '', '1', '10', '', '', 'Int64', 'False'")
                .HasAnnotation("Npgsql:Sequence:.catalog_hilo", "'catalog_hilo', '', '1', '10', '', '', 'Int64', 'False'")
                .HasAnnotation("Npgsql:Sequence:.catalog_type_hilo", "'catalog_type_hilo', '', '1', '10', '', '', 'Int64', 'False'")
                .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn);

            modelBuilder.Entity("Microsoft.eShopOnContainers.Services.Catalog.API.Infrastructure.Catalog", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Microsoft.eShopOnContainers.Services.Catalog.API.Infrastructure.CatalogItem", b =>
            {
                b.HasOne("Microsoft.eShopOnContainers.Services.Catalog.API.Infrastructure.Catalog", "Catalog")
                    .WithMany()
