  ...
  render() {
    return (
      <div className={s.root}>
        ...
        <Row>
          <Col lg={6} xl={4} xs={12}>
            <Widget title={<h6> Sipariş Durumu </h6>} close settings>
              <div className="stats-row">
                <div className="stat-item">
                  <h6 className="name">Tamamlanan Sipariş </h6>
                  <p className="value">76.38%</p>
                </div>
                <div className="stat-item">
                  <h6 className="name">Aylık</h6>
              ...
              <p>
                ...
                <span className="fw-semi-bold">&nbsp;17% Tamamlanan</span>
                &nbsp;son ay siparişler
              </p>
            </Widget>
          </Col>
