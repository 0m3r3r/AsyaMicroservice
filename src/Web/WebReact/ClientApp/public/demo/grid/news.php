...
<ul class="news-list stretchable">
    ...
    <li>
        ...
        <div class="news-item-info">
            <h5 class="name no-margin mb-xs"><a href="#">Asya Promosyon Template reached $300</a></h5>
            <p class="fs-mini">
                Asya Promosyon Inc. shares just hit $300 price. "This was inevitable. It should
